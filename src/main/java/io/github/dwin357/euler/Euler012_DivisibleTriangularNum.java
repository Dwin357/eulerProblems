 ...
 * it seems pretty trivial to create a "triangle num producer"...
 *
 ...
 *   This implies to me another new consumer-component (working-name "terminal")
 *     which essentially implements a peek function
 *
 * Also, I clearly need a "factorer" which accepts a num and returns a list of factors
 *
